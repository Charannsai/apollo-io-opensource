  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-[88px] bg-surface-tertiary rounded-xl" />
        ))}
      </div>
      <div className="grid grid-cols-3 gap-3 mb-8">
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-[72px] bg-surface-tertiary rounded-xl" />
        ))}
      </div>
      <div className="grid grid-cols-2 gap-6">
        <div className="h-[300px] bg-surface-tertiary rounded-xl" />
        <div className="h-[300px] bg-surface-tertiary rounded-xl" />
      </div>
    </div>
  );
